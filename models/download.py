# adapted from 
# https://github.com/makcedward/nlpaug/blob/master/nlpaug/util/file/download.py
...
class DownloadUtil:
    ...
    def download_glove(model_name, dest_dir):
        ...
        elif model_name == '42B.300d':
            url = 'http://nlp.stanford.edu/data/glove.42B.300d.zip'
        elif model_name == '840B.300d':
            url = 'http://nlp.stanford.edu/data/glove.840B.300d.zip'
        elif model_name == 'twitter.27B':
            url = 'http://nlp.stanford.edu/data/glove.twitter.27B.zip'
        else:
            possible_values = ['6B', '42B.300d', '840B.300d', 'twitter.27B']
